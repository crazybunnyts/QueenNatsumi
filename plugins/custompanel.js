...
if (Config.WORKTYPE == 'private') {
    ...
    Natsumi.addCommand({pattern: Config.CUS_PANEL + '?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Natsumi.addCommand({pattern: Config.CUS_PANEL + '?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
