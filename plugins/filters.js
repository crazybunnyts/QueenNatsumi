...
if (Config.LANG == 'SI') f_rep = '*පෙරණය සකසන ලදී ✅*'
...
Natsumi.addCommand({pattern: 'filter ?(.*)', fromMe: true, desc: Lang.FILTER_DESC}, (async (message, match) => {
...
Natsumi.addCommand({pattern: 'stop ?(.*)', fromMe: true, desc: Lang.STOP_DESC}, (async (message, match) => {
